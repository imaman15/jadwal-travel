...
<div class="block-header">
    <?php echo $this->session->flashdata('info'); ?>
                <span style="font-size: 30px;font-weight: bold;">DATA HARIAN</span>
                    ...
                    <div class="card">                        
                        <div class="body">
                            <div class="input-group">
                                            ...
                                            <form action="<?php echo base_url();?>data_harian" method="post">
                                            <div class="form-line" style="width: 150px;">
                                                <input placeholder="Pilih Tanggal" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" name="tgl" value="<?php echo date('Y-m-d');?>" >
                                            </div>
